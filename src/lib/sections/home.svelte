      ...
      <div class="flex-wrapper second">
        <h1 class="title">
          <div class="title-mask">
            <div class="word" bind:this={titleWord1Element}>Aditya</div>
          </div>
          <br />

          <div class="title-mask">
            <div class="word" bind:this={titleWord2Element}>Singh</div>
          </div>
        </h1>
        <div class="occupation mask">
          <p class="paragraph" bind:this={shortDetailsElement}>
            full-stack developer from san francisco, california
          </p>
        </div>
