...
export let loadPagePromise = new Promise(
  (resolve) => (loadPageResolve = resolve)
);
export let loaderAnimationResolve: (value?: any) => void;
export let loaderAnimationPromise = new Promise(
  (resolve) => (loaderAnimationResolve = resolve)
);
