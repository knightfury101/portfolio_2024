<script lang="ts">
  ...
  $: mobileTransitionSwitcher = mobileMenuActive
    ? maskSlideIn
...
<svelte:window
  on:resize={() => (isMobileMenuAllowed = window.innerWidth <= 950)}
/>
...
{#await loadPagePromise then _}
  <div class="nav-wrapper" style="transform: translate(0px);">
    ...
    <div class="flex-wrapper">
          ...
          {#key mobileMenuActive}
            ...
            <li use:introAnimation={{ delay: 1400 }}>
              <a
                ...
                target="_blank"
                in:mobileTransitionSwitcher={{ delay: 450 }}>LinkedIn</a
              >
            </li>
          {/key}
        </ul>
      ...
      <div class="mask">
        <button
          class="interactive hb-button clickable"
          use:introAnimation={{ delay: 1000 }}
